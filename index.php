...
mysqli_select_db($con, 'TruckTracker');
...
if(mysqli_query($con, $TruckTable))
{
...
$TruckTableFK = "ALTER TABLE Truck ADD FOREIGN KEY (TruckID) REFERENCES Driver(TruckID) ON UPDATE CASCADE ON DELETE CASCADE";
if(mysqli_query($con, $DriverTableFK)) {
   // echo  "Foreign Key ";
}
